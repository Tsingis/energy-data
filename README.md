[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=Tsingis_energy-data&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=Tsingis_energy-data) [![Docker Scout](https://github.com/tsingis/energy-data/actions/workflows/scout.yml/badge.svg)](https://github.com/tsingis/energy-data/actions/workflows/scout.yml)
...
- Set up environment `uv sync --no-build`
- Launch `uv run --no-build task api`
